%import shlex, unicodedata, os
    <article class="search-result row">
      <div class="col-xs-12 col-sm-12 col-md-3">
        <a href="download/{{i}}?{{query_string}}" title="Lorem ipsum" class="thumbnail"><img src="http://lorempixel.com/250/140/people" alt="Lorem ipsum" /></a>
      </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-7 excerpet">
        <h3><a href="download/{{i}}?{{query_string}}" title="">{{d['label']}}</a></h3>
        <p>{{!d['snippet']}}</p>
